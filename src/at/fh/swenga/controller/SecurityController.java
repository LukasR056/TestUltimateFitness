...
public class SecurityController {
	...
	public String fillData(Model model) {
		...
		if (users.isEmpty()) 
		{
			UserModel u1 = new UserModel("Robert", "Reitbauer", "MaxSng", now, "m", 1.70, 70.5, null, "max@reitbauer.at", 100,
					 true, "password", null);
			u1.encryptPassword();
			...
			UserModel u3 = new UserModel("Lisa", "Lustig", "Ludi", now, "w", 1.64, 90.9, null, "ludi@lustig.de", 100,
					 true, "password", null);
			u3.encryptPassword();
			...
			UserModel u4 = new UserModel("Walter", "Weber", "user", now, "w", 1.70, 70.5, "WaWe", "walter@weber.de", 100,
					 true, "password", null);
			u4.encryptPassword();
			u4.addRoleModel(userRole);
			userRepository.persist(u4);
			
			UserModel u5 = new UserModel("Christoph", "Hopfer", "admin", now, "m", 1.80, 80.7, "ChrisH", "chris@hopfer.at", 100,
					 true, "password", null);
			u5.encryptPassword();
